...
public class GetStockLevelTest {
  ...
  @Test
  void getStockLevel_whenNoUpdateTime_V3() {
    ...
    Assertions.assertEquals(
        Boolean.TRUE, redisTempl.opsForHash().hasKey(sku, "H08880011801_updatestocktime").block());
  }
  ...
  @Test
  void findSkuStockLevel_whenNoUpdateTime_iims() {
    String sku = "H088800118_S_TEST01";
    String uuid = "test-getStockLevel-uuid-0000-00001";
    ...
    apiUtil.findSkuStockLevelIims(sku);
